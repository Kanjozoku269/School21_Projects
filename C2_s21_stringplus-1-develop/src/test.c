...
START_TEST(s21_memmove_f) {
  char s21_buffer[30] = "teststring";
  char buffer[30] = "teststring";
  ck_assert_str_eq(s21_memmove(s21_buffer + 2, s21_buffer, 10),
                   memmove(buffer + 2, buffer, 10));
...
START_TEST(s21_nums_f) {
  char s21_buffer[256] = {0};
  char buffer[256] = {0};
  s21_sprintf(s21_buffer, "%-2i %5i % i %2i %4d %d %15d %15d %22u %5u %4u %3u",
              101, -210, -0, '0', 101, -210, -0, '0', (unsigned int)101,
              (unsigned int)210, (unsigned int)-0, (unsigned int)'0');
  sprintf(buffer, "%-2i %5i % i %2i %4d %d %15d %15d %22u %5u %4u %3u", 101,
...
START_TEST(s21_nums5_f) {
  char s21_buffer[256] = {0};
  char buffer[256] = {0};
  s21_sprintf(s21_buffer, "|%e| %.3g %E %e %4.10g", 0.000000000078,
              0.0000000000234, 0.000013, 0.000012341234, 0.0000000242424);
  sprintf(buffer, "|%e| %.3g %E %e %4.10g", 0.000000000078, 0.0000000000234,
...
START_TEST(s21_nums6_f) {
  char s21_buffer[256] = {0};
  char buffer[256] = {0};
  s21_sprintf(s21_buffer, "%x %X %u %o %p", 412325, 12785231, 4841292, 91912838,
              "qewqweqwe");
  sprintf(buffer, "%x %X %u %o %p", 412325, 12785231, 4841292, -91912838,
          "qewqweqwe");
}
END_TEST
...
START_TEST(s21_nums7_f) {
  char s21_buffer[256] = {0};
  char buffer[256] = {0};
  s21_sprintf(s21_buffer, "%10.3d   Hello   %d", 412313, -12412312);
  sprintf(buffer, "%10.3d   Hello   %d", 412313, -12412312);
}
END_TEST
...
START_TEST(s21_nums13_d) {
  char s21_buffer[256] = {0};
  char buffer[256] = {0};

  s21_sprintf(s21_buffer, "%*d", 10, 10);
  sprintf(buffer, "%*d", 10, 10);
  ck_assert_str_eq(s21_buffer, buffer);

  s21_sprintf(s21_buffer, "%*.*d", 10, 5, 13);
  sprintf(buffer, "%*.*d", 10, 5, 13);
  ck_assert_str_eq(s21_buffer, buffer);

  s21_sprintf(s21_buffer, "%10.3d   Hello   ", 155);
  sprintf(buffer, "%10.3d   Hello   ", 155);
  ck_assert_str_eq(s21_buffer, buffer);

  s21_sprintf(s21_buffer, "%-10.3d   Hello   ", 4884848);
  sprintf(buffer, "%-10.3d   Hello   ", 4884848);
  ck_assert_str_eq(s21_buffer, buffer);

  s21_sprintf(s21_buffer, "Hell%10c%-5lc world", 'o', L' ');
  sprintf(buffer, "Hell%10c%-5lc world", 'o', L' ');
  ck_assert_str_eq(s21_buffer, buffer);
  ...
  s21_sprintf(s21_buffer, "%Lf hi", (long double)7.7);
  sprintf(buffer, "%Lf hi", (long double)7.7);
  ck_assert_str_eq(s21_buffer, buffer);
}
END_TEST

START_TEST(s21_nums14_X) {
  char s21_buffer[256] = {0};
  char buffer[256] = {0};

  sprintf(s21_buffer, "%2lo", (long)1234567);
  s21_sprintf(buffer, "%2lo", (long)1234567);
  ck_assert_str_eq(s21_buffer, buffer);

  sprintf(s21_buffer, "%2lu", (long)-45);
  s21_sprintf(buffer, "%2lu", (long)-45);
  ck_assert_str_eq(s21_buffer, buffer);

  sprintf(s21_buffer, "School %-10.3u %0u %-10.5hu %lu", (unsigned)12345,
          (unsigned)0, (unsigned short)123456, (unsigned long)123456789000);
  s21_sprintf(buffer, "School %-10.3u %0u %-10.5hu %lu", (unsigned)12345,
              (unsigned)0, (unsigned short)123456, (unsigned long)123456789000);
  ck_assert_str_eq(s21_buffer, buffer);

  sprintf(s21_buffer, "%x", (short int)123500);
  s21_sprintf(buffer, "%x", (short int)123500);
  ck_assert_str_eq(s21_buffer, buffer);

  sprintf(s21_buffer, "School %-10.3x %0x %-#10.5hx %lx", (unsigned)12345,
          (unsigned)0, (unsigned short)123456, (unsigned long)123456789000);
  s21_sprintf(buffer, "School %-10.3x %0x %-#10.5hx %lx", (unsigned)12345,
              (unsigned)0, (unsigned short)123456, (unsigned long)123456789000);
  ck_assert_str_eq(s21_buffer, buffer);
...
Suite *lib_suite(void) {
  ...
  tc_nums_13 = tcase_create("d check");
  suite_add_tcase(s, tc_nums_13);
  tcase_add_test(tc_nums_13, s21_nums13_d);

  tc_nums_14 = tcase_create("X check");
  suite_add_tcase(s, tc_nums_14);
  tcase_add_test(tc_nums_14, s21_nums14_X);
